...
class FirebaseTaskService {
  ...
  Future<void> updateTask(String uid, Task task) async {
    if (task.firebaseId == null) throw Exception('Cannot update task without firebaseId');
    await _col(uid).doc(task.firebaseId).update(task.toFirestore());
  }

  Future<void> markCompleted(String uid, String firebaseId, bool completed) async {
