...
class _SignupScreenState extends State<SignupScreen> {
  ...
  Future<void> _signup() async {
    ...
    if ((match?.group(1) ?? '') != studentId) {
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
        content: Text('Signup Failure: email Student ID must match Student ID field.'),
      ));
      return;
    }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        elevation: 0,
        backgroundColor: AppColors.background,
        title: const Text('Create Account', style: TextStyle(color: AppColors.text)),
        ...
        child: Form(
          ...
          child: ListView(
            ...
            children: [
              ...
              AppTextField(controller: _fullNameCtrl, label: 'Full Name', validator: AuthValidator.fullName),
              _buildGenderSection(),
              AppTextField(
              ...
              AppTextField(
                ...
                obscure: true,
                validator: (v) => AuthValidator.confirmPassword(v, _passwordCtrl.text),
              ),
              ...
              TextButton(
                onPressed: isLoading
                  ...
                  nav.canPop() ? nav.pop() : nav.pushReplacementNamed(LoginScreen.routeName);
                },
  ...
  Widget _buildGenderSection() {
    return Column(
      ...
      children: [
        const Text('Gender (Optional)', style: TextStyle(color: AppColors.text)),
        RadioGroup<String>(
          groupValue: _gender,
          onChanged: (v) => setState(() => _gender = v),
          child: Row(children: [
            Expanded(child: RadioListTile<String>(value: 'Male',   title: const Text('Male'),   groupValue: _gender, onChanged: (v) => setState(() => _gender = v))),
            Expanded(child: RadioListTile<String>(value: 'Female', title: const Text('Female'), groupValue: _gender, onChanged: (v) => setState(() => _gender = v))),
          ]),
        ),
